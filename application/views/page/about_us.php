                            ...
                            <div class="slides" data-group="slides">
                                <ul>
                                    <div class="slide-body" data-group="slide">
                                        <li><img alt="" class="img-responsive" src="<?= img_url() ?>/1.jpg" width="100%" height="350"/></li>
                                        <li><img alt="" class="img-responsive" src="<?= img_url() ?>/2.jpg" width="100%" height="350"/></li>
                                        <li><img alt="" class="img-responsive" src="<?= img_url() ?>/6.jpg" width="100%" height="350"/></li>
                                        <li><img alt="" class="img-responsive" src="<?= img_url() ?>/8.jpg" width="100%" height="350"/></li>
