...
// URL HELPERS
    ...
    if (!function_exists('fonts_url'))
    {
        ...
        {
            $CI = & get_instance();
            return base_url() . $CI->config->item('fonts_path');
        }
...
// PATH HELPERS
    ...
    if (!function_exists('plugin_path'))
    {
        ...
        function plugin_path()
        {
            //get an instance of CI so we can access our configuration
            $CI = & get_instance();
            return FCPATH . $CI->config->item('plugin_path');
        }
    ...
    if (!function_exists('fonts_path'))
    {
        ...
        {
            $CI = & get_instance();
            return FCPATH . $CI->config->item('fonts_path');
        }
...
// EMBED HELPERS
    ...
    if (!function_exists('css'))
    {
        ...
        {
            return '<link rel="stylesheet" type="text/css" href="' . css_url() . $file . '.css" media="' . $media . '">' . "\n";
        }
    ...
    if (!function_exists('less'))
    {
        ...
        function less($file)
        {
            return '<link rel="stylesheet/less" type="text/css" href="' . less_url() . $file . '.less">' . "\n";
        }
    ...
    if (!function_exists('js'))
    {
        ...
        {
            $element = '<script type="text/javascript" src="' . js_url() . $file . '.js"';
    ...
    if (!function_exists('plugin'))
    {
        ...
        function plugin($file, $type, $atts = array())
        {
            switch ($type)
            {
                case "scss":
                case "css":
                    $element = '<link rel="stylesheet" type="text/css" href="' . plugin_url() . $file . '.' . $type . '"';
                    foreach ($atts as $key => $val)
                        $element .= ' ' . $key . '="' . $val . '"';
                    $element .= '>' . "\n";
                    break;
                case "js":
                    $element = '<script type="text/javascript" src="' . plugin_url() . $file . '.' . $type . '"';
                    foreach ($atts as $key => $val)
                        $element .= ' ' . $key . '="' . $val . '"';
                    $element .= '></script>' . "\n";
                    break;
